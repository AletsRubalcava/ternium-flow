...
const consignees = [
    { id: 1, idCustomer: 1, name: "Centro de Distribución Bajío", address: "Carretera Qro-Celaya Km 12.5, Gto." },
    { id: 2, idCustomer: 1, name: "Planta Norte", address: "Zona Industrial Escobedo, NL." },
    { id: 3, idCustomer: 1, name: "Almacén Central - Bodega 4", address: "Av. Ferrocarriles S/N, SLP." },
    { id: 4, idCustomer: 1, name: "Sucursal Occidente", address: "Parque Industrial El Salto, Jal." },
    { id: 5, idCustomer: 2, name: "Sucursal Occidente", address: "Parque Industrial El Salto, Jal." },
];
